...
class NgramCountVectorizer(BaseVectorizer):

    def __init__(self, ngram_range=(1, 2), max_features=1000, min_df=5, max_df=0.8, binary=False):
    ...
    def train(self, dataset):
        ...
        print(f"N-gram Count Vectorizer 학습 중...")
    ...
    def save(self, file_name):
        ...
        print(f"N-gram Count Vectorizer가 '{file_name}'에 저장되었습니다.")
    ...
    def load(self, file_name):
        ...
        self.binary = save_data.get('binary', False)  
        self.is_trained = True
